...
-- Dumping structure for table vpcontract_dev.contractor_staff_health_review
CREATE TABLE IF NOT EXISTS `contractor_staff_health_review` (
  ...
  `RefDocumentCode` varchar(16) NOT NULL DEFAULT '',
  `RefDocTypeCode` varchar(16) NOT NULL DEFAULT '',
  `ReviewDocFileName` varchar(128) NOT NULL DEFAULT '',
  `ReviewDocFilePath` varchar(256) NOT NULL DEFAULT '',
  `ReviewDocFileUrl` varchar(256) NOT NULL DEFAULT '',
  `ReviewNotes` varchar(1024) NOT NULL DEFAULT '',
