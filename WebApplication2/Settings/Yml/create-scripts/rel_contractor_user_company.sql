...
-- Dumping structure for table vpcontract_dev.rel_contractor_user_company
CREATE TABLE IF NOT EXISTS `rel_contractor_user_company` (
  ...
  `DefaultCompany` smallint(1) NOT NULL DEFAULT '0',
