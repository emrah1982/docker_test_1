...
-- Dumping structure for table vpcontract_dev.document_approve_que
CREATE TABLE IF NOT EXISTS `document_approve_que` (
...
) ENGINE=InnoDB AUTO_INCREMENT=368367 DEFAULT CHARSET=utf8;
