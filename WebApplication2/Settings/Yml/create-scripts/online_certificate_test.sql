...
-- Dumping structure for table vpcontract_dev.online_certificate_test
CREATE TABLE IF NOT EXISTS `online_certificate_test` (
  `Id` bigint(16) NOT NULL AUTO_INCREMENT,
  `CompanyCode` varchar(16) NOT NULL DEFAULT '',
  `CertificateCode` varchar(16) NOT NULL DEFAULT '',
  `TestTitle` varchar(512) NOT NULL DEFAULT '',
  `NumQuestions` smallint(6) NOT NULL DEFAULT '0',
  `NumMinCorrectAnswers` smallint(6) NOT NULL DEFAULT '0',
