...
-- Dumping structure for table vpcontract_dev.rel_contractor_type_asset_role
CREATE TABLE IF NOT EXISTS `rel_contractor_type_asset_role` (
  `Id` bigint(16) NOT NULL AUTO_INCREMENT,
  `CompanyCode` varchar(32) NOT NULL DEFAULT '',
  `TypeCode` varchar(32) NOT NULL DEFAULT '',
