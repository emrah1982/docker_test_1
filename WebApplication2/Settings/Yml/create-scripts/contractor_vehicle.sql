...
-- Dumping structure for table vpcontract_dev.contractor_vehicle
CREATE TABLE IF NOT EXISTS `contractor_vehicle` (
  ...
  `VehicleName` varchar(128) NOT NULL DEFAULT '',
  `VehicleBrand` varchar(128) NOT NULL DEFAULT '',
  `VehicleType` smallint(4) NOT NULL DEFAULT '0',
  `VehicleLicensePlate` varchar(128) NOT NULL DEFAULT '',
