...
-- Dumping structure for table vpcontract_dev.contractor_asset_doc
CREATE TABLE IF NOT EXISTS `contractor_asset_doc` (
...
) ENGINE=InnoDB AUTO_INCREMENT=394297 DEFAULT CHARSET=utf8;
