...
-- Dumping structure for table vpcontract_dev.company_health_review_item
CREATE TABLE IF NOT EXISTS `company_health_review_item` (
  `Id` bigint(16) NOT NULL AUTO_INCREMENT,
  `CompanyCode` varchar(16) NOT NULL DEFAULT '',
  `ReviewItemCode` varchar(16) NOT NULL DEFAULT '',
