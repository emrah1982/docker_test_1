...
-- Dumping structure for table vpcontract_dev.rel_contractor_facility
CREATE TABLE IF NOT EXISTS `rel_contractor_facility` (
  ...
  `UdateUser` varchar(256) NOT NULL DEFAULT '',
