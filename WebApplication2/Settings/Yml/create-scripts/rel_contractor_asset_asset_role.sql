...
-- Dumping structure for table vpcontract_dev.rel_contractor_asset_asset_role
CREATE TABLE IF NOT EXISTS `rel_contractor_asset_asset_role` (
...
) ENGINE=InnoDB AUTO_INCREMENT=43593 DEFAULT CHARSET=utf8;
