...
-- Dumping structure for table vpcontract_dev.rel_project_contractor
CREATE TABLE IF NOT EXISTS `rel_project_contractor` (
  ...
  `MethodDocRequired` smallint(1) NOT NULL DEFAULT '0',
  `MethodDocStatus` smallint(1) NOT NULL DEFAULT '0',
...
) ENGINE=InnoDB AUTO_INCREMENT=23091 DEFAULT CHARSET=utf8;
