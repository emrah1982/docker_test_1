...
-- Dumping structure for table vpcontract_dev.online_certificate_test_question_option
CREATE TABLE IF NOT EXISTS `online_certificate_test_question_option` (
  ...
  `OptionCode` varchar(16) NOT NULL DEFAULT '',
  `Option` varchar(256) NOT NULL DEFAULT '',
  `OptionIx` smallint(6) NOT NULL DEFAULT '0',
  `IsCorrectOption` smallint(1) NOT NULL DEFAULT '0',
