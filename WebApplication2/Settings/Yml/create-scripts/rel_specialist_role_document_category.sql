...
-- Dumping structure for table vpcontract_dev.rel_specialist_role_document_category
CREATE TABLE IF NOT EXISTS `rel_specialist_role_document_category` (
  ...
  `IsPreApproveRole` smallint(1) NOT NULL DEFAULT '0',
