...
-- Dumping structure for table vpcontract_dev.work_method
CREATE TABLE IF NOT EXISTS `work_method` (
  ...
  `VersionNotes` varchar(2048) COLLATE utf8_bin NOT NULL DEFAULT '',
  `ApproveStatus` smallint(1) NOT NULL DEFAULT '0',
  `ApproveDateTime` datetime DEFAULT NULL,
  `ApproveUserCode` varchar(32) COLLATE utf8_bin NOT NULL DEFAULT '',
  `ApproveUser` varchar(256) COLLATE utf8_bin NOT NULL DEFAULT '',
  `ApproveDesc` varchar(2048) COLLATE utf8_bin NOT NULL DEFAULT '',
