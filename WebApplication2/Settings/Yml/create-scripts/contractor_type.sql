...
-- Dumping structure for table vpcontract_dev.contractor_type
CREATE TABLE IF NOT EXISTS `contractor_type` (
  ...
  `ContractorTypeName` varchar(256) NOT NULL DEFAULT '',
  `ContractorTypeDesc` varchar(1024) NOT NULL DEFAULT '',
