...
-- Dumping structure for table vpcontract_dev.online_certificate_auth
CREATE TABLE IF NOT EXISTS `online_certificate_auth` (
  ...
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB AUTO_INCREMENT=25936 DEFAULT CHARSET=utf8;
