...
-- Dumping structure for table vpcontract_dev.rel_project_contractor_asset
CREATE TABLE IF NOT EXISTS `rel_project_contractor_asset` (
...
) ENGINE=InnoDB AUTO_INCREMENT=73461 DEFAULT CHARSET=utf8;
